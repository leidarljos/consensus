...
(Herbster and Warmuth, doi:10.1023/A:1007424614876) 0.877. Fifteen
voters: 0.877, 0.936, 0.974, 0.976, 0.891, 0.937. Log-odds calibration
reaches within half a point of the ceiling from the ballots alone; the
online rules stand where linear calibration stands. =ljos calibrate=
writes log odds for that reason.
