...
settle_anchored, settle_bounded, dawid_skene, surprisingly_popular,
eigentrust, ballots_from_json, trust_from_json, anchors_from_json,
predictions_from_json, settle_seldon}=. The Seldon module
